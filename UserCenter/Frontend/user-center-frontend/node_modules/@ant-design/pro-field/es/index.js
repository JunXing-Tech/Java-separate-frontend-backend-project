...
var FieldSelectHOC = fieldHOC(FieldSelect);
/**
...
var defaultRenderText = function defaultRenderText(dataValue, valueType, props, valueTypeMap) {
  ...
  if (customValueTypeConfig) {
    ...
    if (mode === 'read') {
      ...
      return (_customValueTypeConfi = customValueTypeConfig.render) === null || _customValueTypeConfi === void 0 ? void 0 : _customValueTypeConfi.call(customValueTypeConfig, dataValue, _objectSpread(_objectSpread({
        ...
        mode: mode || 'read'
      }), /*#__PURE__*/React.createElement(React.Fragment, null, dataValue));
    }
    ...
    if (mode === 'update' || mode === 'edit') {
      ...
      return (_customValueTypeConfi2 = customValueTypeConfig.renderFormItem) === null || _customValueTypeConfi2 === void 0 ? void 0 : _customValueTypeConfi2.call(customValueTypeConfig, dataValue, _objectSpread({
        text: dataValue
      }, props), /*#__PURE__*/React.createElement(React.Fragment, null, dataValue));
    }
  }
  ...
  if (valueType === 'date') {
    var FieldDatePickerHOC = fieldHOC(FieldDatePicker);
    return /*#__PURE__*/React.createElement(FieldDatePickerHOC, _extends({
      text: dataValue,
      format: "YYYY-MM-DD"
    }, props));
  }
  ...
  if (valueType === 'dateWeek') {
    var _FieldDatePickerHOC = fieldHOC(FieldDatePicker);

    return /*#__PURE__*/React.createElement(_FieldDatePickerHOC, _extends({
      text: dataValue,
      format: "YYYY-wo",
      picker: "week"
    }, props));
  ...
  if (valueType === 'dateMonth') {
    var _FieldDatePickerHOC2 = fieldHOC(FieldDatePicker);

    return /*#__PURE__*/React.createElement(_FieldDatePickerHOC2, _extends({
      text: dataValue,
      format: "YYYY-MM",
      picker: "month"
    }, props));
  ...
  if (valueType === 'dateQuarter') {
    var _FieldDatePickerHOC3 = fieldHOC(FieldDatePicker);

    return /*#__PURE__*/React.createElement(_FieldDatePickerHOC3, _extends({
      text: dataValue,
      format: "YYYY-\\QQ",
      picker: "quarter"
    }, props));
  ...
  if (valueType === 'dateYear') {
    var _FieldDatePickerHOC4 = fieldHOC(FieldDatePicker);

    return /*#__PURE__*/React.createElement(_FieldDatePickerHOC4, _extends({
      text: dataValue,
      format: "YYYY",
      picker: "year"
    }, props));
  ...
  if (valueType === 'dateTime') {
    var _FieldDatePickerHOC5 = fieldHOC(FieldDatePicker);

    return /*#__PURE__*/React.createElement(_FieldDatePickerHOC5, _extends({
      text: dataValue,
  ...
  if (valueType === 'time') {
    var _FieldDatePickerHOC6 = fieldHOC(FieldTimePicker);

    return /*#__PURE__*/React.createElement(_FieldDatePickerHOC6, _extends({
      text: dataValue,
      format: "HH:mm:ss"
    }, props));
  }
  ...
  if (valueType === 'index') {
    return /*#__PURE__*/React.createElement(FieldIndexColumn, null, dataValue + 1);
  }
  ...
  if (valueType === 'digitRange') {
    return /*#__PURE__*/React.createElement(FieldDigitRange, _extends({
      text: dataValue
    }, props));
  }
  ...
  if (valueType === 'select' || valueType === 'text' && (props.valueEnum || props.request)) {
    return /*#__PURE__*/React.createElement(FieldSelectHOC, _extends({
      text: dataValue
    }, props));
  }
  ...
  if (valueType === 'treeSelect') {
    return /*#__PURE__*/React.createElement(FieldTreeSelect, _extends({
      text: dataValue
    }, props));
  }
...
var ProField = function ProField(_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, defaultRenderText(mode === 'edit' ? (_ref2 = (_fieldProps$value = fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) !== null && _fieldProps$value !== void 0 ? _fieldProps$value : text) !== null && _ref2 !== void 0 ? _ref2 : '' : (_ref3 = text !== null && text !== void 0 ? text : fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) !== null && _ref3 !== void 0 ? _ref3 : '', valueType || 'text', _objectSpread(_objectSpread({
    ref: ref
  }, rest), {}, {
