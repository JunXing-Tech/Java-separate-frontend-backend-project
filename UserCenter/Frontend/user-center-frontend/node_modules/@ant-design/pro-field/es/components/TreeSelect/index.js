...
var FieldTreeSelect = function FieldTreeSelect(_ref, ref) {
  ...
  if (mode === 'edit') {
    ...
    var _dom = /*#__PURE__*/React.createElement(_Spin, {
      ...
      className: classNames(fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.className, layoutClassName, _defineProperty({}, "".concat(coreStyleClassName, "-active"), (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) && light))
    })));
