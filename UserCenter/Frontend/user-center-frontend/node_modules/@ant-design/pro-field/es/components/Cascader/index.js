...
var _excluded = ["radioType", "renderFormItem", "mode", "render", "light"];
...
var FieldCascader = function FieldCascader(_ref, ref) {
  ...
  var coreStyleClassName = getPrefixCls('pro-core-field-label');
  ...
  if (mode === 'edit') {
    var _rest$fieldProps3, _rest$fieldProps4;
    ...
    var _dom = /*#__PURE__*/React.createElement(_Cascader, _extends({
      ...
      className: classNames((_rest$fieldProps3 = rest.fieldProps) === null || _rest$fieldProps3 === void 0 ? void 0 : _rest$fieldProps3.className, layoutClassName, _defineProperty({}, "".concat(coreStyleClassName, "-active"), (rest === null || rest === void 0 ? void 0 : (_rest$fieldProps4 = rest.fieldProps) === null || _rest$fieldProps4 === void 0 ? void 0 : _rest$fieldProps4.value) && light)),
      options: options
    }));
