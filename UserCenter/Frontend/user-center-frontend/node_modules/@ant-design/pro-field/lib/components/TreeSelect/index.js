...
var _excluded = ["radioType", "renderFormItem", "mode", "light", "render"],
...
var FieldTreeSelect = function FieldTreeSelect(_ref, ref) {
  ...
  if (mode === 'edit') {
    ...
    var _dom = /*#__PURE__*/_react.default.createElement(_spin.default, {
      ...
      className: (0, _classnames.default)(fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.className, layoutClassName, (0, _defineProperty2.default)({}, "".concat(coreStyleClassName, "-active"), (fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) && light))
    })));
