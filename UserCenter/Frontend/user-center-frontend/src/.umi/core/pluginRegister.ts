...
import * as Plugin_2 from 'D:/Project/UserCenter/Frontend/user-center-frontend/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'D:/Project/UserCenter/Frontend/user-center-frontend/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
